...
const PlanCard = ({ 
  ...
  return (
    <div className={`bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden transition-all duration-300 ${isActive ? 'transform scale-105 shadow-xl' : 'opacity-80'}`}>
      <div className="flex">
        <button
      ...
      <div className="p-6">
        {isPopular && (
          <div className="bg-memblue/20 text-memcyan text-xs font-semibold px-3 py-1 rounded-full w-fit mx-auto mb-3">
            MAIS POPULAR
          </div>
        )}
        ...
        <div className="relative">
          ...
          <Link
            to="/create"
            className="relative block w-full text-center bg-gradient-to-r from-memblue to-memcyan hover:from-memblue-dark hover:to-memcyan-dark text-white font-medium rounded-full py-3 px-4 transition-all duration-300"
          >
            Começar agora
          </Link>
        </div>
