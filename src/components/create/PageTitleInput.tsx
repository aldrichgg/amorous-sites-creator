      ...
      >
        <div className="group relative">
          <Input
            ...
            className="w-full pl-4 pr-10 py-3 bg-black/60 border border-white/20 text-white focus:border-memcyan/50 transition-all duration-300 shadow-lg shadow-black/30 backdrop-blur-sm font-manrope"
          />
