...
const Navbar = () => {
  ...
  return (
    <>
      <div className="w-full bg-pink-400 text-white py-2 px-4 text-center text-sm flex items-center justify-center animate-pulse-soft">
        <span className="mr-1">♥</span> Dia internacional das mulheres! Memórias temáticas - Todos os planos com 50% de desconto!
      </div>

      <header className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black/80 backdrop-blur-lg shadow-lg' : 'bg-transparent'}`}>
