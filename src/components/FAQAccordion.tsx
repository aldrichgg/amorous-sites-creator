...
const FAQAccordion = () => {
  ...
  const faqItems: FAQItem[] = [
    {
      question: 'O que é o Loveiit?',
      answer: 'O Loveiit é uma plataforma que permite criar sites personalizados para guardar e compartilhar memórias especiais com pessoas queridas. Através da nossa ferramenta, você pode criar páginas únicas com fotos, mensagens e elementos interativos.'
    },
    {
      question: 'Não recebi a memória, o que fazer?',
      answer: 'Se você não recebeu sua memória após o pagamento, verifique sua caixa de spam e lixeira. Caso não encontre, entre em contato com nosso suporte através do email suporte@loveiit.com informando o número da transação que você recebeu após o pagamento.'
    },
    {
      question: 'Como posso criar uma página personalizada no Loveiit?',
    ...
    },
    {
      ...
      answer: 'Imediatamente após a confirmação do pagamento, você receberá um e-mail com o link da sua página e um QR Code que pode ser compartilhado. Você também pode acessar suas memórias através da sua conta no Loveiit a qualquer momento.'
    },
    {
    ...
    {
      question: 'Qual é o custo para criar uma página no Loveiit?',
